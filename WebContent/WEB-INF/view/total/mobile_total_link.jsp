...
<s:action name="User_mobile_navbar" namespace="/user"
	...
	<a id="totjdw_a" class="mui-action-back mui-icon mui-icon-left-nav mui-pull-left"></a>
		<!-- <a style="color: white;" class="mui-icon mui-icon-more"
			id='showUserPicker'></a> -->
		<h1 class="mui-title" style="color: white;">案件情况</h1>
		...
		<div class="mui-card" style="margin:0px;">
			...
			<div class="mui-card-header" style="padding: 0px;">
				<div class="mui-card-header">
					<div>
						<span id="span_total_department">统计</span>
						<span style="margin: 0 10px;">-</span> 
						<span id="span_total_user">案件情况</span>
					</div>
				</div>
			</div>
			<!--内容区-->
	...
	<script type="text/javascript">
		...
		document.getElementById("totjdw_a").addEventListener("tap", function() {
			mui.openWindow({
				url : '/ajdbxt/total/Total_mobile_departmentStatistic',
			});
		});
