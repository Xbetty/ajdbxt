...
<body>
			...
			<div class="panel-heading">
				<div>
					<h3 class="panel-title">
						<span id="span_total_department">统计</span> <span>-</span> <span
							id="span_total_user">案件情况</span>
					</h3>
				</div>
			</div>
							...
							<div style="height: 34px; width: 100%;">
								...
								<div class="input-group" style="width: 300px; float: right;">
									<input id="input_Total_CaseSearchText" class="form-control"
										oninput="List_Total_link(1,totalCase,select_start_time,select_stop_time,department_id,policeId)" type="text"
	...
	<script type="text/javascript" src="<%=basePath%>js/Total/ajdbxtTotalLink.js"></script>
</body>
</html>